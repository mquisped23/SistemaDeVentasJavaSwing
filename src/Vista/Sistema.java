...
public final class Sistema extends javax.swing.JFrame {
    ...
    public void ListarVentasBuscar(int id) {
        List<Venta> ListarVenta = (List<Venta>) Vdao.BuscarVenta(id);
        modelo = (DefaultTableModel) TableVentas.getModel();
        Object[] ob = new Object[4];
        for (int i = 0; i < ListarVenta.size(); i++) {
            ob[0] = ListarVenta.get(i).getId();
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(80, 133, 139));

        btnNuevaVenta.setBackground(new java.awt.Color(153, 153, 153));
        btnNuevaVenta.setFont(new java.awt.Font("Ebrima", 1, 14)); // NOI18N
        ...
        btnProveedor.setFont(new java.awt.Font("Ebrima", 1, 14)); // NOI18N
        ...
        btnConfig.setFont(new java.awt.Font("Ebrima", 1, 14)); // NOI18N
        ...
        LabelVendedor.setFont(new java.awt.Font("Dialog", 1, 22)); // NOI18N
        ...
        jTabbedPane1.setBackground(new java.awt.Color(161, 210, 206));

        jPanel2.setBackground(new java.awt.Color(161, 210, 206));
        ...
        jTabbedPane1.addTab("Nueva Vneta", jPanel2);

        jPanel3.setBackground(new java.awt.Color(161, 210, 206));
        ...
        jPanel4.setBackground(new java.awt.Color(161, 210, 206));
        ...
        jPanel5.setBackground(new java.awt.Color(161, 210, 206));
        ...
        jPanel6.setBackground(new java.awt.Color(161, 210, 206));
        ...
        jPanel6.add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 40, 190, -1));

        jLabel38.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel38.setForeground(new java.awt.Color(0, 0, 0));
        jLabel38.setText("Filtro:");
        jPanel6.add(jLabel38, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 40, -1, -1));
        ...
        jTabbedPane1.addTab("CONFIGURACION DE LA EMPRESA", jPanel7);

        jPanel12.setBackground(new java.awt.Color(161, 210, 206));
        ...
        jPanel14.setBackground(new java.awt.Color(80, 133, 139));

        jLabel2.setFont(new java.awt.Font("Edwardian Script ITC", 1, 100)); // NOI18N
        jLabel2.setText("Monhark Company");

        jLabel39.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/iconoempresa.png"))); // NOI18N

        jLabel40.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/iconoempresa.png"))); // NOI18N
    ...
    private void txtBuscarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyTyped
       txtBuscar.addKeyListener(new KeyAdapter() {
           ...
           public void keyReleased(KeyEvent e) {
            tr.setRowFilter(RowFilter.regexFilter("(?i)"+txtBuscar.getText(), 0,1));
           }
